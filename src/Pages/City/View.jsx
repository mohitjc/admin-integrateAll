               ...
               <div className="col-span-6 flex flex-col mb-5">
                ...
                <div className="col-span-6 flex flex-col mb-5">
                  ...
                  <p className="text-[14px] text-black font-medium capitalize">
                    {" "}
                    {/* <LiaUserSolid className="text-xl text-[#1E5DBC]" /> */}
                    {data && data.countryData && data.countryData?.name}                    
                  </p>
                </div>
                <div className="col-span-6 flex flex-col mb-5">
                  <label className="text-[14px] text-[#0000009c] tracking-wider mb-1 "> State Name:</label>
                  <p className="text-[14px] text-black font-medium capitalize">
                    {" "}
                    {/* <LiaUserSolid className="text-xl text-[#1E5DBC]" /> */}
                    {data && data.regionData && data.regionData?.name}
                  </p>
                </div>
                <div className="col-span-6 flex flex-col mb-5">
                  <label className="text-[14px] text-[#0000009c] tracking-wider mb-1 ">City Name:</label>
                  <p className="text-[14px] text-black font-medium capitalize">
                    {" "}
                    {/* <LiaUserSolid className="text-xl text-[#1E5DBC]" /> */}
                    {data && data.name}
